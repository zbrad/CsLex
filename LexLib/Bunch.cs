...
namespace LexLib
{
    public class Bunch
    {
         ...
         * Member Variables
         */
        List<Nfa> nfa_set; /* List of Nfa states in dfa state */
        ...
        public List<Nfa> GetNFASet() { return nfa_set; }
        public void SetNFASet(List<Nfa> a) { nfa_set = a; }
  ...
  Console.Write("\n");
        ...
        public void move(Dfa dfa, int b)
        {
            int size;
            Nfa state;
            List<Nfa> old_set = dfa.GetNFASet();
